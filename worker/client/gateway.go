...
type Gateway interface {
	...
	Connect(nodeInfo domain.NodeInfo) error
	Disconnect()
	IsConnected() bool
...
func (gc *GatewayClient) SendTaskStatus(taskID string, status domain.TaskStatus, progress int, metadata map[string]interface{}) error {
...
// reconnectLoop 重连循环
func (gc *GatewayClient) reconnectLoop(nodeInfo domain.NodeInfo) {
